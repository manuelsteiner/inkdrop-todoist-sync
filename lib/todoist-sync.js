...
module.exports = {
    config: {
        ...
        activeLabel: {
            ...
            description: 'If set, notes with status active will be exported with an additional label. This setting is independent from the setting that controls label synchronisation.',
            type: 'string',
            default: '',
        },
        onHoldLabel: {
            title: 'Todoist label for notes with status on hold',
            description: 'If set, notes with status on hold will be exported with an additional label. This setting is independent from the setting that controls label synchronisation.',
            type: 'string',
            default: '',
        },
        exportCompleted: {
        ...
        exportDropped: {
            ...
            description: 'If this feature is enabled, dropped notes are exported as completed Todoist tasks.',
            type: 'boolean',
            default: false,
        },
        importSubTasks: {
        ...
        exportNoteBodies: {
            ...
            description: 'If this feature is enabled, note bodies will be exported to Todoist task descriptions. Otherwise the note bodies will note be exported. Be aware that Todoist only supports a small sub-set of Markdown formatting options.',
            type: 'boolean',
            default: false,
        },

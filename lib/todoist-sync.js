...
module.exports = {
    config: {
        apiKey: {
            ...
            description: 'Your Todoist API key that allows todoist-sync to access your Todoist data. You can find it in Todoist under Settings -> Integrations -> API Tokens.',
            type: 'string',
            default: '',
        },
        syncDirection: {
        ...
        exportSection: {
            ...
            description: 'If set, notes will be exported to this section in each project. This is useful to easily spot which tasks were exported from Inkdrop. Otherwise notes will be attached to the Todoist project without a section.',
            type: 'string',
            default: '',
        },
        importSections: {
        ...
        syncCompleted: {
            ...
            description: 'If this feature is enabled, completed notes and tasks are synchonised between Inkdrop and Todoist.',
            type: 'boolean',
            default: false,
        },
        importSubTasks: {
            title: 'Import Todoist sub tasks',
            description: 'If this feature is enabled, Todoist sub tasks will be imported as notes into the notebook that corresponds to the project containing the main task. Otherwise sub tasks will not be imported. Be aware of implications on subsequent synchronisations!',
            type: 'boolean',
            default: false,
        },
        ...
        exporttNotebooksAsSections: {
            title: 'Treat leaf notebooks as Todoist sections corresponding projects are absent',
            description: 'If this feature is enabled, leaf (deepested nested) notebooks will be exported as Todoist sections if not corresponding project is found. This means missing Todoist projects are created until the second to last level. The last level will then become a section in the project. If this feature is disabled, leaf notebooks will become projects and the tasks will not contain any sections. Be aware of implications on subsequent synchronisations!',
            type: 'boolean',
            default: false,
        },
        ...
        importTaskDescriptions: {
            ...
            description: 'If this feature is enabled, the task description will be imported as note body when creating notes. Otherwise the note body will be emtpy.',
            type: 'boolean',
            default: true,
        },
    },
        ...
        inkdrop.commands.add(document.body, {
            'todoist-sync:sync-all': async () => {
                try {
                    ...
                    inkdrop.logger.error('todoist-sync:sync-all: Synchronising all notebooks and projects failed. Details: ' +
                        error.message);
        ...
        inkdrop.commands.add(document.body, {
            'todoist-sync:sync-selected': async () => {
                try {
                    ...
                    inkdrop.logger.error('todoist-sync:sync-all: Synchronising selected notebooks and projects failed. Details: ' +
                        error.message);
                    inkdrop.notifications.addError('Todoist synchronisation failed', {
        ...
        inkdrop.commands.add(document.body, {
            'todoist-sync:export-all-books': async () => {
                try {
                    ...
                    inkdrop.logger.error('todoist-sync:export-all-books: Exporting all notebooks failed. Details: ' +
                        error.message);
        ...
        inkdrop.commands.add(document.body, {
            'todoist-sync:export-selected-books': async () => {
                try {
                    ...
                    inkdrop.logger.error('todoist-sync:export-selected-books: Exporting selected notebooks failed. Details: ' +
                        error.message);
                    inkdrop.notifications.addError('Todoist export failed', {
        ...
        inkdrop.commands.add(document.body, {
            'todoist-sync:export-selected-notes': async () => {
                try {
                    ...
                    inkdrop.logger.error('todoist-sync:export-selected-notes: Exporting selected notes failed. Details: ' +
                        error.message);
                    inkdrop.notifications.addError('Todoist export failed', {

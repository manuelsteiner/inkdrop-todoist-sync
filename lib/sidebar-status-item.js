...
const SidebarStatusItem = () => {
    ...
    const [syncStatus, setSyncStatus] = (0, react_1.useState)('active');
    (0, react_1.useEffect)(() => {
        const handler = (event) => {
    ...
    return (react_1.default.createElement(SideBarMenuItem, { className: "sidebar-menu-todoist-sync sync-" + syncStatus, indentLevel: 0, renderIcon: () => (react_1.default.createElement("svg", { className: "streamline-icon" + (syncStatus === types_1.SYNC_STATUS.ACTIVE ? " animate-spin" : ""), width: "1em", height: "1em", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 600 600" },
